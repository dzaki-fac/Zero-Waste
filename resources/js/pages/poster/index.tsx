...
export default function KelolaPoster({ posters }: Props) {
    ...
    function handleAdd(e: React.FormEvent) {
        e.preventDefault();
        addForm.post(route('admin.poster.store'), {
            preserveScroll: true,
            onSuccess: () => {
                setAddOpen(false);
...
return;
        ...
        editForm.patch(route('admin.poster.update', { poster: editingItem.id }), {
            preserveScroll: true,
            onSuccess: () => {
                setEditOpen(false);
                setEditingItem(null);
...
return;
        ...
        router.delete(route('admin.poster.destroy', { poster: deletingItem.id }), {
            preserveScroll: true,
            onSuccess: () => {
                setDeleteOpen(false);
