...
export default function PilahSampahEdit({ pilahSampah }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route(auth.user.role === 'admin' ? 'admin.pilah-sampah.update' : 'petugas.pilah-sampah.update', { pilah_sampah: pilahSampah.id }));
    };
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            ...
                            <Button variant="outline" asChild className="border-green-200 text-green-700 hover:bg-green-50">
                                <Link href={route(auth.user.role === 'admin' ? 'admin.pilah-sampah.index' : 'petugas.pilah-sampah.index')} className="flex items-center gap-1">
